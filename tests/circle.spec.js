...
/*
  ...
  Comportamento:
    - circle(1) // Retorno: {circle: 1, area: 3.14, circumference: 6.28}
    - circle(7) // Retorno: {circle: 7, area: 153.86, circumference: 43.96}
    - circle(3) // Retorno: {circle: 3, area: 28,26, circumference: 18.84}
...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(circle('notnumber')).toBeUndefined();
